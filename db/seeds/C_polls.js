exports.seed = function (knex, Promise) {
  return Promise.all([
    ...
    knex('polls').insert([
      ...
      { creator: 'JohnSmith1@example.com', poll_title: 'What is the best flavor of ice cream?', admin_url: 'nf87cn/admin', poll_url: 'nu0tv2', is_open: true, created_at: '2017-12-30 21:06:57.472486+00', updated_at: '2017-12-31 19:06:57.472486+00' },
      { creator: 'JaneDoe999@example.com', poll_title: 'You will be stranded on an island. You are allowed to bring one thing. What will you bring?', admin_url: 'r3gei5/admin', poll_url: 'g9devs', is_open: true, created_at: '2017-12-29 21:06:57.472486+00', updated_at: '2017-12-30 19:06:57.472486+00' },
    ])
  ])
}
