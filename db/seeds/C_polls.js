exports.seed = function (knex, Promise) {
  return Promise.all([
    ...
    knex('polls').insert([
      ...
      { creator: 'JohnSmith1@example.com', poll_title: 'What is the best food?', admin_url: 'nf87cn/admin', poll_url: 'nu0tv2', is_open: true, created_at: '2017-12-30 21:06:57.472486+00', updated_at: '2017-12-31 19:06:57.472486+00' },
